...
**As of v2025.11.0**, RADIUSS Shared CI is available as **GitLab CI Components** (requires GitLab 17.0+). This provides:
...
include:
  ...
  - component: $CI_SERVER_FQDN/radiuss/radiuss-shared-ci/base-pipeline@v2025.11.0
    inputs:
